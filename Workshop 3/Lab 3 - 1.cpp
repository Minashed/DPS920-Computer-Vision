...
cv::Scalar colorOfBox = (0x00, 0x00, 0xff); //Default red
...
int main(int argc, char** argv) {
	...
	// a)Increase the size of the image to 480 (rows) x 640 (columns)
	...
	// b) Move the top left corner of the window to location (10, 30)
...
void my_mouse_callback(int event, int x, int y, int flags, void* param){
	...
	switch (event) {
		...
		//If the left left mouse button is clicked
